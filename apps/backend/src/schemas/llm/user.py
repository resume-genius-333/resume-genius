...
class UserLLMSchema(BaseLLMSchema):
    ...
    linkedin_url: Optional[HttpUrl] = Field(
        ...
        json_schema_extra={
            ...
            "examples": ["https://linkedin.com/in/johndoe", "https://www.linkedin.com/in/jane-smith"]
        }
    )
    ...
    github_url: Optional[HttpUrl] = Field(
        ...
        json_schema_extra={
            ...
            "examples": ["https://github.com/johndoe", "https://www.github.com/janesmith"]
        }
    )
    ...
    educations: List[EducationLLMSchema] = Field(
        ...
        json_schema_extra={
            "llm_context": "Extract all educational experiences"
        }
    )
    ...
    projects: List[ProjectLLMSchema] = Field(
        ...
        json_schema_extra={
            "llm_context": "Extract all projects mentioned"
        }
    )
